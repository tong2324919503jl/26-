"""External truth checks are confined to this test runner, never the policy."""
from sweep_localization import *
from problem4.experiments.localization import OptimizedSearchPolicy
from problem3.geometry import contains
cases=generate_suite(4,'development_v2')
output={}
for name, cls in [('legacy',LegacyPolicy),('history_localization',OptimizedSearchPolicy)]:
...
violations=[]
for c in cases:
    s=LocalSimulator(c);s.enter();p=OptimizedSearchPolicy()
...
out=ROOT/'problem4/results/localization_development_v2.json'
